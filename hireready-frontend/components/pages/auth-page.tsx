...
import { Briefcase, User, Building2, Mail, Lock, ArrowLeft } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode === 'signup' && (
              <div className="space-y-3">
                <Label className="text-[#1C1C1E]">I am a</Label>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className={cn(
                      ...
                      selectedRole === 'job-seeker' ? "bg-[#1C1C1E]" : "bg-[#F3F4F6]"
                    )}>
                      <User className={cn(
                        "h-6 w-6",
                        selectedRole === 'job-seeker' ? "text-white" : "text-[#6B7280]"
                      )} />
                    </div>
                    <span className={cn(
                      "text-sm font-medium",
                  ...
                  >
                    <div className={cn(
                      "flex h-12 w-12 items-center justify-center rounded-full",
                      selectedRole === 'recruiter' ? "bg-[#1C1C1E]" : "bg-[#F3F4F6]"
                    )}>
                      <Briefcase className={cn(
                        "h-6 w-6",
                        selectedRole === 'recruiter' ? "text-white" : "text-[#6B7280]"
                      )} />
                    </div>
                    <span className={cn(
                      "text-sm font-medium",
